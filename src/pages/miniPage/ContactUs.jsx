...
const ContactUs = () => {
  return (
    <div className="bg-gray-100 text-gray-800 px-6 lg:px-20 py-14">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-lg text-gray-700 mb-8 leading-relaxed">
            ...
            Puedes escribirnos directamente o llenar el formulario,
          ...
          <div className="space-y-6 mt-6">
            <div className="flex items-center gap-4 bg-white p-4 rounded-xl shadow-sm border hover:shadow-md transition">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">+57 320 000 0000</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-white p-4 rounded-xl shadow-sm border hover:shadow-md transition">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">contacto@huilaexplorer.com</p>
              </div>
            </div>
      ...
      {/* Imagen / Ilustración inferior */}
      <div className="mt-16 text-center">
        <img
          src="https://cdn-icons-png.flaticon.com/512/854/854878.png"
          alt="contact illustration"
          className="w-40 md:w-52 mx-auto opacity-80"
        />
      </div>
    </div>
  );
