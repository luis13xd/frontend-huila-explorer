...
const RelatedBlog = () => {
    ...
    return (
        <div>
            <h3 className='text-2xl font-medium pt-8 pb-5'>
                Sitios relacionados
            </h3>
            <hr />
            {
                blogs.length > 0
                    ? (<div className='space-y-4 mt-5'>
                        {
                            blogs.map((blog) => (
                                ...
                                >
                                    ...
                                    <div>
                                        <h4 className='font-semibold text-[#1E73BE]'>{blog?.title.substring(0, 50)}</h4>
                    ...
                    : (<div className='p-8'>No hay sitios recomendados</div>)
